...
public class Lobby{
   ...
   public void removeYou()
   {
	...
	private Tree treePlayers;
	private TreeItem root;
	private TreeItem rootTwo;
	private Composite copmpoPlayers;
	...
	public void createContents() {
		...
		copmpoPlayers = new Composite(compoGameInfo, SWT.NONE);
		...
		treePlayers = new Tree(copmpoPlayers, SWT.BORDER);
		treePlayers.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
		root = new TreeItem(treePlayers, SWT.NONE);
		root.setText("Global");
		//rootTwo = new TreeItem(treePlayers, SWT.NONE);
	...
	public Tree getTreePlayers() {
		return treePlayers;
	}

	public void setTreePlayers(Tree treePlayers) {
		this.treePlayers = treePlayers;
	}

	public TreeItem getRootTwo() {
		return rootTwo;
	}

	public Composite getCopmpoPlayers() {
		return copmpoPlayers;
	}
