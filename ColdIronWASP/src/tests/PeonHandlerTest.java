...
/**
 * 
 * Tests the PeonHandler
 *
 */
public class PeonHandlerTest {
	...
	@Test
	public void testAddNewPeon() throws JSONException, Exception{
		init();
	...
	public void testChangeLevel() throws JSONException, Exception{
		...
		Assert.assertNotNull(peon);
		Assert.assertEquals((long)20, (long)peon.getLevel());
	}
}
