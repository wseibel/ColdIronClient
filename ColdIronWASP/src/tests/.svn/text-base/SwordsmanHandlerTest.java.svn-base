...
/**
 * Tests the SwordsmanHandler
 */
public class SwordsmanHandlerTest {
	...
	@Test
	public void testAddNewSwordsman() throws JSONException, Exception{
		init();
		...
		Assert.assertNotNull(swordsman);
	}
	...
	public void testChangeLevel() throws JSONException, Exception{
		...
		Assert.assertNotNull(swordsman);
		Assert.assertEquals((long)20, (long)swordsman.getLevel());
	}
}
